...
export default function page() {
  return (
    <section className="bg-[#000] relative h-screen w-screen">
      ...
      <div className={"absolute top-0 left-0 w-full lg:w-[70%] h-screen opacity-5 lg:opacity-10 bg-gradient-to-b lg:bg-gradient-to-r from-green-600 to-transparent"} />
      <Image className="absolute -left-30 w-full lg:w-2/3 h-full hidden lg:block" src="/images/glow-homepage.png" alt="" width="100" height="1000" draggable={false} priority />
      <div
        className="absolute w-full lg:w-auto p-10 top-1/2 left-1/2 lg:top-1/2 lg:left-10 3xl:left-60 transform -translate-x-1/2 -translate-y-1/2 lg:translate-x-0">
