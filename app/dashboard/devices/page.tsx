        ...
        <div className="rounded-sm border border-stroke shadow-default dark:border-strokedark ">
            ...
            {deviceData.map((device, key) => (
                <Link
                    ...
                    className={"grid grid-cols-5 border-t border-stroke py-4.5 px-4 dark:border-strokedark sm:grid-cols-12 md:px-6 2xl:px-7.5 text-sm text-black dark:text-white bg-[#fafafa] dark:bg-[#313235] hover:bg-[#f5f5f5] dark:hover:bg-meta-4 transition-colors duration-200"}
                    key={key}
                >
                    <div className="col-span-1 flex items-center">
